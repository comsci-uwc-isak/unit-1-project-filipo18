...
4. This comand is used to search for the line that starts with argument entered by the user and delete it in file defined ``` sed -i "/$1/d" maincarfile.txt ``` ([Source]https://www.folkstalk.com/2013/03/sed-remove-lines-file-unix-examples.html), published 3. Jul 2013, retrived 28. Oct 2019)
